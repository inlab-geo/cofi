...
if not on_rtd:
    sphinx_gallery_conf = {
        ...
        "filename_pattern": ".",
        "ignore_pattern": "._lib.py|_preprocessing.py|xrayTomography.py|thin_plate_inversion.py|travel_time_tomography.py|fmm_tomography.py|neptune_deterministic_methods.py",
        "pypandoc": True,
