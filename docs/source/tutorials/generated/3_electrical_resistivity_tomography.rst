...
.. GENERATED FROM PYTHON SOURCE LINES 70-137
...
.. GENERATED FROM PYTHON SOURCE LINES 174-310
...
.. GENERATED FROM PYTHON SOURCE LINES 423-489
...
.. GENERATED FROM PYTHON SOURCE LINES 500-516
...
.. GENERATED FROM PYTHON SOURCE LINES 538-552
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Iteration #1, objective function value: 224.79875151413603
    Iteration #2, objective function value: 220.3623726879749
    Iteration #3, objective function value: 215.9057002091078
    Iteration #4, objective function value: 211.6177561325521
...
.. GENERATED FROM PYTHON SOURCE LINES 571-590
...
.. GENERATED FROM PYTHON SOURCE LINES 601-615
...
.. GENERATED FROM PYTHON SOURCE LINES 618-650
...
.. GENERATED FROM PYTHON SOURCE LINES 650-666
...
.. GENERATED FROM PYTHON SOURCE LINES 671-689
...
.. GENERATED FROM PYTHON SOURCE LINES 696-713
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Iteration #1
      objective value: 69.41232753902366
    Iteration #2
      model change: 1.952192034607357
      objective value: 32.31371502955874
    Iteration #3
      model change: 2.005000505011244
      objective value: 31.171940388085797
    Iteration #4
      model change: 0.37747947597238296
      objective value: 27.46044537825156
    Iteration #5
      model change: 1.2758048179583017
      objective value: 17.69101254349577
...
.. GENERATED FROM PYTHON SOURCE LINES 715-731
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Iteration #3
      ...
      objective value: 34.9026409087144
    Iteration #4
      model change: 0.0
      objective value: 34.9026409087144
    Iteration #5
      model change: 1.9999999999999998
      objective value: 22.814718920753556
...
.. GENERATED FROM PYTHON SOURCE LINES 733-749
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Iteration #3
      ...
      objective value: 51.74447637862935
    Iteration #4
      model change: 2.235768382076734
      objective value: 32.60775764542323
    Iteration #5
      model change: 1.7295706120940206
      objective value: 29.213175185082527
...
.. GENERATED FROM PYTHON SOURCE LINES 754-799
...
.. GENERATED FROM PYTHON SOURCE LINES 806-820
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Iteration #2, objective value: 107.12950312045996
    Iteration #3, objective value: 76.24719314425752
    Iteration #4, objective value: 59.93096014283097
    Iteration #5, objective value: 53.93390880663674
    Iteration #6, objective value: 53.88443707299383
    Iteration #7, objective value: 53.81331650273363
    Iteration #8, objective value: 53.72275180400429
    Iteration #9, objective value: 53.61502389633202
...
.. GENERATED FROM PYTHON SOURCE LINES 825-835
...
.. GENERATED FROM PYTHON SOURCE LINES 850-856
...
.. rst-class:: sphx-glr-timing
   ...
   **Total running time of the script:** ( 1 minutes  3.469 seconds)
