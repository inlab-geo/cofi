...
1. Navigate to the GitHub repository (`cofi <https://github.com/inlab-geo/cofi>`_,
   ...
   add or edit things in the `example gallery <cofi-examples/_sphinx_gallery/generated/index.html>`_)
...
complexity presented in the `example gallery <cofi-examples/_sphinx_gallery/generated/index.html>`_ 
...
.. list-table:: Table: documentation page mapping to file path
   ...
   * - `Tutorials <tutorial.html>`_
     - docs/tutorial.rst
   * - `Example gallery (front page) <cofi-examples/_sphinx_gallery/generated/index.html>`_
     - `cofi-examples <https://github.com/inlab-geo/cofi-examples>`_ scripts/README.rst
   * - `Exmaple gallery (examples content) <cofi-examples/_sphinx_gallery/generated/index.html>`_
