...
# Add Neighpy class into src/cofi/tools/__init__.py
# FIXME 1. "from _neighpy import Neighpy"
# FIXME 2. add "Neighpy" to "__all__" list
# FIXME 3. add "Neighpy" to "inference_tools_table" dictionary
